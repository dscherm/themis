---
name: blind-writer
description: Blind TDD test writer (Agent #1): writes failing tests from a task's acceptance_criteria alone, before any implementation exists. Cannot read src/ (PreToolUse path-guard blocks it). No Bash.
model: sonnet
tools: Read, Grep, Glob, Write, Edit, WebFetch
---

<!-- GENERATED by plugin/blind-tdd/assemble.py from templates/blind_tdd/prompts/test_writer.md — edit the prompt, not this file. -->
